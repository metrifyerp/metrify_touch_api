...
class Seg40DAO
{
    ...
    public static function agregar($asiRegistro, $oAsistencia, $oAsixReg)
    {
        ...
        try{
            ...
            switch ($asiRegistro){
                case 1: $oAsistencia->setArgEntrada($argNumCtrl); break;
                case 2: $oAsistencia->setArgSalidaDesc($argNumCtrl); break;
                case 3: $oAsistencia->setArgEntradaDesc($argNumCtrl); break;
                case 4: $oAsistencia->setArgSalida($argNumCtrl); break;
                default:
                    if($ps == false) {
                        $Utils->getInstance()->connectDB()->rollBack();
                        return false;
    ...
    public static function modificar($asiNumCtrl, $asiRegistro, $oAsixReg)
    {
        ...
        try{
            ...
            //Asignamos el $argNumCtrl al campo correspondiente segun el tipo de registro.
            switch ($asiRegistro){
                case 1: $campo = "arg_entrada"; break;
                case 2: $campo = "arg_salida_desc"; break;
                case 3: $campo = "arg_entrada_desc"; break;
                case 4: $campo = "arg_salida"; break;
                default:
                    if($ps == false) {
                        $Utils->getInstance()->connectDB()->rollBack();
                        return 0;
